...
def write_model(model_path, input_base_path, model_size, tokenizer_path=None, safe_serialization=True):
    ...
    if not os.path.isfile(os.path.join(input_base_path, "params.json")):
        if (
            ...
            or model_size == "13B"
            or model_size == "70B"
            or model_size == "7B-chat"
            or model_size == "13B-chat"
            or model_size == "70B-chat"
        ):
            input_base_path = os.path.join(input_base_path, LLAMA_2_BASE_FOLDER_NAME + model_size.lower())
        else:
